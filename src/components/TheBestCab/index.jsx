...
<div>
    ...
    <div className="container__general">
        <div className="app-content">
            ...
            <h2 className="title">The best cab app <br />
            for your mobile app.</h2>
            ...
            <h3>Dowload App Now...</h3>
                <div className="app__buttons">
                    <a href="https://www.apple.com/ios/app-store/"><i
                    className="fab fa-apple"></i> app store</a>
                    <a href="https://play.google.com/store?hl=en"><i
                    className="fab fa-android"></i> playstore</a>
                </div>
        </div>
